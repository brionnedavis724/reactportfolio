...
export default function AboutPic() {
    ...
    <div className='aboutPic'>
        <div className='profilePic'>
            <img className='pic' src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse4.mm.bing.net%2Fth%3Fid%3DOIP.Yj3WbOortcYgbSkGBnIVFAHaHa%26pid%3DApi&f=1" alt="bizphoto" />
         </div>
        <div className='intro'>
